...
public class DataServiceConfigTest {
	...
	private static Logger logger = LoggerFactory.getLogger(DataServiceConfigTest.class);
	...
	public DataSource dataSource() {
		try {DriverManagerDataSource ds = new DriverManagerDataSource();
		    ...
		    ds.setUrl("jdbc:mysql://localhost:3307/GestioneDispositiviTest?createDatabaseIfNotExist=true");
		    ds.setUsername("root");
